...
const Dropdown = ({ options, label, placeholder, status = "default", onChange }) => {
  ...
  return (
    <div className="dropdown" ref={dropdownRef}>
      <div className="dropdown__wrapper">
        ...
        {status === "error" && <div className="dropdown__error">
                <img className="dropdown__error-icon" src={errorIcon} alt="error" />
                <span className="dropdown__error-text">{error || "This field is required"}</span>
            </div>}
